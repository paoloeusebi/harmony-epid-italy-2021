...
- \textcolor{red}{Likelihood $Bin(10,12)$}
...
- The Beta distribution is a family of continuous probability distributions defined on the [0, 1] interval parameterized by two positive "shape" parameters  $\alpha$ and $\beta$.
